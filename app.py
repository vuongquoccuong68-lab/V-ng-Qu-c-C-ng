...
<div class="main-header">
    ...
    <p>Tác giả: Vương Quốc Cường - Trường Tiểu học Vĩnh Hảo, xã Vĩnh Tuy, tỉnh Tuyên Quang - ĐT: 0977 821 509</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vương Quốc Cường - Trường Tiểu học Vĩnh Hảo, xã Vĩnh Tuy, tỉnh Tuyên Quang- ĐT: 0977 821 509</div>", unsafe_allow_html=True)
